...
@section('content')
 <!-- Page Heading -->
 <h1 class="h3 mb-4 text-gray-800">Edit a Skill</h1>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="name_en" id="name_en" class="form-control @error('name_en')
                is-invalid
            @enderror" placeholder="Name in English" value="{{ old('name_en',  $skill->en_name) }}">
            @error('name_en')
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="name_ar" id="name_ar" class="form-control @error('name_ar')
                is-invalid
            @enderror" placeholder="الاسم بالعربية" value="{{ old('name_ar', $skill->ar_name) }}">
            @error('name_ar')
                <small class="invalid-feedback">{{ $message }}</small>
            @enderror
        </div>
